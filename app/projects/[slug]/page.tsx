      ...
      <div className="max-w-4xl mx-auto p-4 md:p-8">
        ...
        <div className="mt-4">
          ...
          <div className="mt-2 flex flex-wrap gap-2">
              ...
              <span key={t} className={`px-2 py-1 border rounded text-xs ${isDarkMode ? 'border-white/20' : 'border-black/20'}`}>
                {t}
              </span>
            ))}
          </div>
        ...
        <div className="mt-8">
          <Carousel className="w-full">
            <CarouselContent>
              {project.images.map((img, idx) => (
                <CarouselItem key={idx}>
                  <div className={`relative aspect-video w-full overflow-hidden rounded-lg border ${isDarkMode ? 'border-white/20' : 'border-black/20'}`}>
            ...
            <CarouselPrevious className={`bg-transparent border ${isDarkMode ? 'border-white text-white' : 'border-black text-black'}`} />
            <CarouselNext className={`bg-transparent border ${isDarkMode ? 'border-white text-white' : 'border-black text-black'}`} />
          </Carousel>
        </div>
      </div>
    </div>
